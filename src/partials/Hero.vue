<template>
  <section class="relative">
    ...
    <!-- Bg -->
    <div class="absolute inset-0 rounded-bl-[100px] mb-28 md:mb-0 bg-gradient-to-tr from-blue-500 to-blue-800 pointer-events-none -z-10" aria-hidden="true"></div>
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
          ...
          <div class="md:w-[600px]">
            ...
            <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4 mb-12 md:mb-0" data-aos="fade-up" data-aos-delay="300">
              <div>
                <router-link class="btn-sm w-full inline-flex items-center text-slate-100 bg-slate-800 hover:bg-slate-900 group shadow-sm" to="/apply">
                  Get early access
              ...
              <div>
                <router-link class="btn-sm w-full inline-flex items-center text-white bg-gradient-to-tr from-blue-400 hover:bg-blue-500 shadow-sm relative before:absolute before:inset-0 before:bg-blue-400 before:bg-opacity-60 before:-z-10 before:rounded-full" to="/support">Read more</router-link>
              </div>
            </div>
