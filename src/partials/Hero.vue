      ...
      <div class="pt-36 md:pt-40 md:pb-20">
        ...
        <div class="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
          ...
          <div class="md:w-[600px]">
            ...
            <!-- Copy -->
            <h1 class="h1 text-white mb-6" data-aos="fade-up" data-aos-delay="100">Increase your customer feedback with <span class="relative inline-flex items-center justify-center">
            ...
            <p class="text-lg text-blue-200 mb-8" data-aos="fade-up" data-aos-delay="200">Send a single link, and let the feedback flow!<br class="hidden md:block" /> Whether it’s an insightful audio message, an expressive video, or a detailed written comment, Guess makes collecting feedback a breeze.</p>
